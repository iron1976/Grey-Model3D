void ImGuiShatteredStyle(const int WIDTH, const int HEIGHT)
{
	...
	//Transparency Control _w
	style->Colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.05f, 0.07f, 0.99f);
	...
	style->Colors[ImGuiCol_ButtonHovered] = ImVec4(0.6f, 0.1f, 0.3f, 1.00f);
...
void ImGuiTransparentWindow(const int WIDTH, const int HEIGHT)
{
	ImGuiIO& io = ImGui::GetIO();
	io.IniFilename = NULL;
	ImGuiStyle* style = &ImGui::GetStyle();
	...
	style->GrabMinSize = 5.0f;
	style->GrabRounding = 3.0f;
	style->Colors[ImGuiCol_Text] = ImVec4(0.90f, 0.90f, 0.93f, 0.00f);
	style->Colors[ImGuiCol_TextDisabled] = ImVec4(0.24f, 0.23f, 0.29f, 0.00f);

	//Transparency Control _w
	style->Colors[ImGuiCol_WindowBg] = ImVec4(0.06f, 0.05f, 0.07f, 0);
	...
	style->Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.24f, 0.23f, 0.29f, 1.00f);
	style->Colors[ImGuiCol_FrameBgActive] = ImVec4(0.56f, 0.56f, 0.58f, 1.00f);
	style->Colors[ImGuiCol_TitleBg] = ImVec4(0.10f, 0.09f, 0.12f, 0.00f);
	style->Colors[ImGuiCol_TitleBgCollapsed] = ImVec4(1.00f, 0.98f, 0.95f, 0.75f);
